...
#------------------------------Analysis of results---------------------------------------------
folder_name = "results\\alpha_critical_analysis\\alphas_n3_18_5\\"
...
save_matrices_txt("Qopts.txt", Qopts)
...
p = plot(α, dual_numbers,
    label="dual FCC",
    xlabel="alpha",
    ylabel="Total lattice frequencies",
    marker=:o,
    color = :orange,
    size = (800, 300),
    left_margin = 10mm,
    ...
    linewidth=1,
    xticks = xmin:tiks:xmax + 0.0009,
    legend = :left
)

#plot!(p, α, fcc_numbers,
 #   label="FCC",
#    marker=:o,
#    linewidth=2
